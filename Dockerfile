...
COPY pdf/fonts/NotoEmoji-Regular.ttf /usr/share/fonts/truetype/noto/NotoEmoji-Regular.ttf
RUN chmod 644 /usr/share/fonts/truetype/noto/NotoEmoji-Regular.ttf && fc-cache -f -v
